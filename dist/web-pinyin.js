...
var PINYIN_DICT = buildPinyinCache(__webpack_require__(13));
var Pinyin = __webpack_require__(14);
...
var PHONETIC_SYMBOL = __webpack_require__(46);
var RE_PHONETIC_SYMBOL = new RegExp("([" + (0, _keys2.default)(PHONETIC_SYMBOL).join("") + "])", "g");
...
var Pinyin = function () {
  function Pinyin(dict) {
    (0, _classCallCheck3.default)(this, Pinyin);

    this._dict = dict;
  }

  (0, _createClass3.default)(Pinyin, [{
    key: "convert",
